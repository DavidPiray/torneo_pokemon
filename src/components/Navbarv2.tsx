      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center">
            <button className="flex items-center gap-2 bg-[#5865F2] hover:bg-[#4752C4] text-white px-6 py-2.5 rounded-lg font-bold transition-all duration-300 shadow-lg hover:shadow-[#5865F2]/50 hover:-translate-y-0.5">
              <svg
                className="w-5 h-5"
                fill="currentColor"
                viewBox="0 0 24 24"
